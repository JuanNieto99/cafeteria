<?php 
	...
	$data = consultar_datos_producto(Encryptar::decrypt_($_GET['id']));
...
<body>
	...
	<div class="container-fluid">
		<div class="jumbotron">
			<div class="row">
				<div class="col-10">
					 <h1 class="display-4"><?=cafeteria24?></h1>
				</div>
				<div  class="col-2" >
 			...
 			<form name="editarProducto">
 				<div class="row">
 					...
 					<div class="col-4">
 						...
 						<input type="text" name="referencia" id="referencia" class="form-control" value="<?=$data['referencia'] ?>">
 					</div>
 					<div class="col-4">
 						<label for="precio"><?=cafeteria4?></label>
 						<input type="number" name="precio"  id="precio" class="form-control" value="<?=$data['precio'] ?>">
 					</div>
 				...
 				<div class="row">
 					<div class="col-4">
 						...
 						<input type="number" name="peso" id="peso" class="form-control" value="<?=$data['peso'] ?>">
 					</div>
 					<div class="col-4">
 						<label for="categoria"><?=cafeteria6?></label>
 						<input type="text" name="categoria" id="categoria" class="form-control" value="<?=$data['categoria'] ?>">
 					</div>
 					<div class="col-4">
 						<label for="stock"><?=cafeteria7?></label>
 						<input type="number" name="stock" id="stock" class="form-control" value="<?=$data['stock'] ?>">
 						<input type="hidden" name="case" value="modificar_producto">
